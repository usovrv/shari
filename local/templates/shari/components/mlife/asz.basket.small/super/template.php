...
<div class="cart"><?=GetMessage("MLIFE_ASZ_BASKET_SMALL_T_TOVAR")?>: <?=$arResult["ORDER"]["CNT"]?>, <?=GetMessage("MLIFE_ASZ_BASKET_SMALL_T_SUMM")?>: <?=$arResult["ORDER"]["ITEMSUMFIN_DISPLAY"]?></div>
<?}else{?>
