				...
				$.ajax({
					 ...
					 success: function (data, textStatus) {
						if(data != 'ok'){
							...
							<a class="button button-primary button-nuka" href="<?=SITE_DIR?>personal/basket/"><?=GetMessage("MLIFE_ASZ_CATALOG_SECTION_E_3")?></a><a class="button button-primary button-nuka b-close"><?=GetMessage("MLIFE_ASZ_CATALOG_CLOSER")?></a>';
							createPopupDiv(cnt);
						}else{
							$('.mlfSmallcart1').trigger('refreshBasket');
							var cnt = "";
