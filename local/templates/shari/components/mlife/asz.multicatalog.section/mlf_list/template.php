...
<div class="row">
	...
	foreach($arResult['ITEMS'] as $item){
		$d++;
		?>
    <div class="col-sm-8 col-md-6 col-lg-4 products prod<?=$item['ID']?>">
        <div class="productwrap">
                ...
                <a href="<?=$item['DETAIL_PAGE_URL']?>">
					...
					?>
                        ...
                        <div class="label color<?=$i?>"><?=$item["PROP"][$labelCode]["NAME"]?>
                            <?if($item["PROP"][$labelCode]["VALUE"]!="Y"){?>: <?=$item["PROP"][$labelCode]["VALUE"]?>
                            <?}?>
                        </div>
                        <?}?>
                        <?}?>
            ...
            <div class="desc">
                <div class="leftDesc">
                    <h6 class="name"><a href="<?=$item['DETAIL_PAGE_URL']?>"><?=$item['NAME']?></a></h6>
                </div>
                <div class="rightDesc">
                    ...
                    <div class="shareWrapper">
                        <div class="titleDay"><?=GetMessage("MLIFE_ASZ_CATALOG_DAY_TITLE_MAIN")?>:</div>
                        <div class="share" id="share_<?=$item["ID"]?>"></div>
                    </div>
                    <?}?>
                    ...
                    <div class="price">
                        ...
                        <div class="newPrice">
                            <?=\Mlife\Asz\CurencyFunc::priceFormat($arResult['DISCOUNT'][$item["ID"]]['DISCOUNT_PRICE'])?>
                        </div>
                        <?}else{?>
                    ...
                    <?if($arResult["PRICE"][$item["ID"]]["VALUE"]>0){?>
                    <div class="addToCart button-primary button-nuka">
                        <a href="javascript:void(0);"
                            data-id="<?=$item["ID"]?>"><?=GetMessage("MLIFE_ASZ_CATALOG_SECTION_T_2");?></a>
                    </div>
                    <?}?>
                    <?}?>
                </div>
